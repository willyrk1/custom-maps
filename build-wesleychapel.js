...
// Real addresses for unlabeled OSM pins (matched by brand + within 0.1mi).
const ADDRESS_OVERRIDES = [
  { brand: 'cvs', lat: 28.18508, lng: -82.35460, addr: '1929 Bruce B Downs Blvd' } // SR 56 & Bruce B Downs
];
// Closed/relocated pins OSM still lists (matched by brand + within 0.1mi).
const STORE_EXCLUDE = [
  { brand: 'winndixie', lat: 28.23993, lng: -82.36472 } // 27301 Wesley Chapel Blvd — permanently closed
];
